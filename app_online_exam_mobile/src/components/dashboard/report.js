...
export default function DashboardReportApp(props) {
    const barData = {
      labels: ['History', 'Date-2', 'Geography', 'Literature', 'Maths', 'Geometry', 'Physics', 'Chemistry', 'Biology', 'Literature', 'Philosophy'],
      datasets: [
        {
          data: [null, 5, null, 4.25, 20, 10, 8, 6, 3.75, 8, 9, 3],
        },
      ],
    };
    const config = {
      ...
      backgroundGradientFrom: '#FFB800',
      backgroundGradientTo: '#FFB800',
      propsForBackgroundLines:{
        stroke:"#FFB800"
      },
      strokeWidth: 1,
      fillShadowGradient:'#474646',
      fillShadowGradientOpacity:1,
      color: (opacity = 1) => `rgb(71, 70, 70, ${opacity})`,
      labelColor: (opacity = 1) => `rgb(71, 70, 70, ${opacity})`,
      style: {
        marginVertical: 8,
        borderRadius: 10
      },
    ...
    return (
      <View style={styles.container}>
          <Text style={{marginBottom: 20, backgroundColor: '#F9F9F9', paddingBottom: 10, paddingTop: 10}}> 
                  ...
                  <TouchableOpacity onPress={() => props.onSelectLanguage('Report')}>
                      <Text style={styles.myHomeBtnView}>  My Reports</Text>
                      </TouchableOpacity>
          ...
          <View style={styles.headerWrapper}>
            ...
            <DataTable style={styles.tableWrapper}>
              ...
              <DataTable.Title style={styles.headerStyle}>Types of Results</DataTable.Title>
              <DataTable.Title style={styles.headerStyle} numeric>Point</DataTable.Title>
              <DataTable.Title style={styles.headerStyle} numeric>Overall Score Average</DataTable.Title>
              <DataTable.Title style={styles.headerStyle} numeric>General Desk</DataTable.Title>
              <DataTable.Title style={styles.headerStyle} numeric>General %</DataTable.Title>
              </DataTable.Header>

              <DataTable.Row style={styles.headerStyle}>
              <DataTable.Cell>SAY</DataTable.Cell>
              <DataTable.Cell numeric>100</DataTable.Cell>
              <DataTable.Cell numeric>168</DataTable.Cell>
              <DataTable.Cell numeric>230</DataTable.Cell>
              <DataTable.Cell numeric>78</DataTable.Cell>
              </DataTable.Row>

              <DataTable.Row style={styles.rowStyle}>
              <DataTable.Cell>EA</DataTable.Cell>
              <DataTable.Cell numeric>100</DataTable.Cell>
              <DataTable.Cell numeric>168</DataTable.Cell>
              <DataTable.Cell numeric>230</DataTable.Cell>
              <DataTable.Cell numeric>78</DataTable.Cell>
              ...
              <DataTable.Row style={styles.rowStyle}>
              <DataTable.Cell>SOZ</DataTable.Cell>
              <DataTable.Cell numeric>100</DataTable.Cell>
              <DataTable.Cell numeric>168</DataTable.Cell>
              <DataTable.Cell numeric>230</DataTable.Cell>
              <DataTable.Cell numeric>78</DataTable.Cell>
              ...
              <DataTable.Row style={styles.rowStyle}>
              <DataTable.Cell>TYT</DataTable.Cell>
              <DataTable.Cell numeric>100</DataTable.Cell>
              <DataTable.Cell numeric>168</DataTable.Cell>
              <DataTable.Cell numeric>230</DataTable.Cell>
              <DataTable.Cell numeric>78</DataTable.Cell>
            ...
            <View style={{marginTop: 20, alignContent: 'center', alignItems: 'center', justifyContent: 'center'}}>
              <Text>
                <TouchableOpacity>
                  <Text style={{color:'#0702FF', textDecorationLine: 'underline', fontSize: 15}}>Click here</Text>
                </TouchableOpacity> 
                <TouchableOpacity>
                  <Text> to view your detailed interactive report</Text>
                </TouchableOpacity>
              </Text>
            </View>
          </View>
